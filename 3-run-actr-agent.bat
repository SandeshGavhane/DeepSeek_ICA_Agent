...
cd C:\DeepSeek_ICA_Agent

REM Create a temporary Lisp script file
echo ;;; ACT-R Agent Loader Script > actr_temp.lisp
REM Add command to load ACT-R
echo (load "C:/DeepSeek_ICA_Agent/actr7.x/load-act-r.lisp") >> actr_temp.lisp
REM Add command to load the experiment interface
echo (load "C:/DeepSeek_ICA_Agent/geomates/act-r-experiment.lisp") >> actr_temp.lisp

REM Add command to load the experiment interface
echo (load "C:/DeepSeek_ICA_Agent/geomates/execution-interface.lisp") >> actr_temp.lisp
REM Add command to load the experiment interface
echo (load "C:/DeepSeek_ICA_Agent/geomates/pddl-interface.lisp") >> actr_temp.lisp
...
echo (load-act-r-model "C:/DeepSeek_ICA_Agent/geomates/DeepSeekAgent.lisp") >> actr_temp.lisp
