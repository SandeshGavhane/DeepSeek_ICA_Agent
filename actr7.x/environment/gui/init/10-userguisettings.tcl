...
if {$reset_window_sizes != "yes"} {
  ...
  set window_config(.visicon) 1955x625+581+90
  set changed_window_list(.visicon) 1
  set window_config(.stepper) 792x524+1272+652
  ...
  set window_config(.control_panel) 415x1197+1766+186
  ...
  set window_config(.buffers) 470x240+2086+409
